# TELBlazor-DevShowCase
This repo has a workflow that receives an artifact and hosts an in development TELBlazor showcase page. It is triggered by a TELBlazor repo workflow.
